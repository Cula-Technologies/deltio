...
mod tests {
    ...
    fn known_timestamp() {
        ...
        assert_eq!(format_rfc3339(time), "2026-03-27T13:49:25.852+00:00");
    }
    ...
    fn leap_year() {
        ...
        assert_eq!(format_rfc3339(time), "2024-02-29T00:00:00.000+00:00");
    }
    ...
    fn end_of_year() {
        ...
        assert_eq!(format_rfc3339(time), "2025-12-31T23:59:59.999+00:00");
    }
    ...
    fn no_millis() {
        ...
        assert_eq!(format_rfc3339(time), "2000-01-01T00:00:00.000+00:00");
    }
    ...
    fn century_leap_year() {
        ...
        assert_eq!(format_rfc3339(time), "2000-02-29T12:00:00.000+00:00");
    }
    ...
    fn non_leap_century() {
        ...
        assert_eq!(format_rfc3339(time), "2100-03-01T00:00:00.000+00:00");
    }
    ...
    fn day_before_non_leap_century() {
        ...
        assert_eq!(format_rfc3339(time), "2100-02-28T23:59:59.999+00:00");
    }
}
